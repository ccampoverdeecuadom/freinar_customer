...
class _OrdersWidget extends State<OrdersWidget> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        floatingActionButton: FloatingActionButton(
          onPressed: () {
            showFloatingModalBottomSheet(
              context: context,
              builder: (context) =>
                  NewAddressTo(senderAddress: widget.senderAddress,
                      orderAdded: (orderDetail) {
        ...
        body: Container(
          ...
          child:  Column(
          children: [
            Container(height: MediaQuery.of(context).size.height - 180,
          ...
          ordersList == null ? SizedBox(height: 0,) :
          ListView.separated(
            ...
            itemBuilder: (context, index) {
              return DeliveryAddressesItemWidget(
                  orderDetails: ordersList.elementAt(index));
            },
          ),
          ),
            ],),),
  ...
  addNewOrderDetails(OrderDetails orderDetails) {
    setState(() {
