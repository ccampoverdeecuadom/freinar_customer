...
class ParcelDetailsEmpty extends StatefulWidget {
   dynamic vendor_name;
   dynamic vendor_id;
   dynamic distance;
   dynamic city_id;
  ...
  State<StatefulWidget> createState() {
    return ParcelDetailsEmptyState();
  }
}

class ParcelDetailsEmptyState extends State<ParcelDetailsEmpty> {
